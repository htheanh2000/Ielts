...
<style>
  ...
  .vocab-gloss { display: block; font-size: 21px; line-height: 1.38; font-weight: 500; color: var(--ink); margin-bottom: 4px; }
  .vocab-pair { display: block; font-size: 20px; color: var(--ink-muted); margin-top: 2px; line-height: 1.4; }
...
practice_block(
    ...
    """<div class="vocab-grid compact">
         <div class="vocab-item"><div class="vocab-word">covers / area</div><div class="vocab-meaning"><span class="vocab-gloss">Park size (extent): how many hectares the site covers — same idea as the listen-back &ldquo;two numbers, one sentence&rdquo; line.</span><span class="vocab-pair">Question: <em>Area</em> · Audio: <em>covers … hectares</em></span></div></div>
         <div class="vocab-item"><div class="vocab-word">hectare · acre</div><div class="vocab-meaning"><span class="vocab-gloss">Two area units in one clause; the gap label tells you which unit to write (hectares → <strong>69</strong>, not acres).</span><span class="vocab-pair">Lesson cue: <em>170 acres</em> + <em>69 hectares</em> — match the printed unit.</span></div></div>
         <div class="vocab-item"><div class="vocab-word">wetland · ponds · stream</div><div class="vocab-meaning"><span class="vocab-gloss">Water features named in order on the wetland route — the last gap is the narrow flowing water word.</span><span class="vocab-pair">Question: <em>lakes, ponds and a ___</em> · Audio: chain ending in <em>stream</em></span></div></div>
         <div class="vocab-item"><div class="vocab-word">collect &amp; analyse data</div><div class="vocab-meaning"><span class="vocab-gloss">Science fieldwork: gather facts about plants (same meaning as &ldquo;look at information&rdquo; on the form).</span><span class="vocab-pair">Question: <em>look at … about plants</em> · Audio: <em>data about the things they see</em></span></div></div>
         <div class="vocab-item"><div class="vocab-word">map · compass · navigate</div><div class="vocab-meaning"><span class="vocab-gloss">Geography skill: find direction with map + compass (listen-back: <em>use</em> vs <em>reading</em> rewording).</span><span class="vocab-pair">Question: <em>use a … and compass</em> · Audio: <em>reading a map and using a compass</em></span></div></div>
         <div class="vocab-item"><div class="vocab-word">focus on · concentrates on</div><div class="vocab-meaning"><span class="vocab-gloss">Leisure &amp; tourism block: what the session mainly spends time on — who visits the park.</span><span class="vocab-pair">Question: <em>concentrates on</em> · Audio: <em>focuses on</em> (visitors)</span></div></div>
         <div class="vocab-item"><div class="vocab-word">create / make sounds</div><div class="vocab-meaning"><span class="vocab-gloss">Music activity: build sounds from natural materials; rhythm/tempo already printed — gap is the countable noun you hear.</span><span class="vocab-pair">Question: <em>make ___ with natural materials</em> · Audio: <em>create … sounds</em> (same activity)</span></div></div>
         <div class="vocab-item"><div class="vocab-word">sense of freedom</div><div class="vocab-meaning"><span class="vocab-gloss">Benefit: children feel less restricted outdoors (listen-back: <em>feeling of</em> = <em>sense of</em>).</span><span class="vocab-pair">Question: <em>feeling of</em> · Audio: <em>sense of</em></span></div></div>
         <div class="vocab-item"><div class="vocab-word">develop / learn skills</div><div class="vocab-meaning"><span class="vocab-gloss">Benefit: discover new abilities, then greater self-confidence (listen-back: <em>learn</em> ↔ <em>develop</em>).</span><span class="vocab-pair">Question: <em>learn new ___</em> · Audio: <em>develop new … skills</em></span></div></div>
