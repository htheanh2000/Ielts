#!/usr/bin/env python3
"""Generate listening/lesson/2/index.html — 21 slides (lý thuyết + Practice 02 / Cambridge 19 S2; no wrap-up)."""

import os
from html import escape

FOOTER = "IELTS Listening · Lesson 02"
TOTAL_SLIDES = 21
...
<head>
<meta charset="utf-8">
<title>IELTS Listening — Section 2 · MCQ &amp; Map · Lesson 02</title>
...
<section data-label="Title" class="slide title-slide">
  <div class="left">
    ...
    <h1 class="main">Section 2<br><em>MCQ &amp; Map.</em></h1>
    <div class="mark">Lesson 02 · Lý thuyết + một bài Section 2</div>
  </div>
  <div class="right">
    ...
    <dl class="meta-grid">
      ...
      <div><dt>Thực hành</dt><dd>Cambridge 19 · Test 1 · Section 2 — Stanthorpe (audio + listen-back)</dd></div>
...
<section data-label="Agenda" class="slide">
  ...
  <ol class="num-list tight">
    <li><div><span class="step-title">Lý thuyết.</span><span class="step-body">8 slide · ~15 phút. Cấu trúc 4 section · MCQ Section 2 · map / diagram · tín hiệu discourse · spelling.</span></div></li>
    <li><div><span class="step-title">Practice 02 · Section 2 — Stanthorpe Twinning Association.</span><span class="step-body">11 slide · ~35 phút. Cambridge 19 Test 1 · MCQ 11–15 + map 16–20 · audio · 5 slide listen-back · từ vựng/paraphrase.</span></div></li>
  </ol>
  {foot(2)}
</section>""")
...
<section data-label="Objectives" class="slide slide--paper">
  ...
  <ol class="num-list">
    ...
    <li><div><span class="step-title">Làm MCQ Section 2: stem + distractor — không chọn ý chỉ “nghe thấy một phần”.</span><span class="step-body">So khớp thì / ngữ cảnh; cảnh giác với đáp án đảo thứ tự hoặc đúng cho thị trấn khác.</span></div></li>
...
#   listening/lesson/2/audio/cam19-test1-part2.mp3
...
practice_block(
    ...
    f"""<h2 class="h-sub" style="font-size: 32px; margin-bottom: 14px;">Questions <strong>11–20</strong> · Choose the correct letter, <strong>A</strong>, <strong>B</strong> or <strong>C</strong>. / Write the correct letter, <strong>A–H</strong>, next to each question on the map.</h2>
       ...
       <p class="source-note">Recording from <strong>Cambridge IELTS 19</strong> (licensed pack) — copy to <code>listening/lesson/2/audio/cam19-test1-part2.mp3</code> (e.g. from <code>Test1 Part2.mp3</code>). Audioscript reference: <a href="https://www.izone.edu.vn/luyen-thi-ielts/giai-cam-19-test-1-listening-part-2-stanthorpe-twinning-association/#b.-audioscripts" target="_blank" rel="noopener">izone.edu.vn</a> (study aid; keys checked against official Cambridge).</p>""",
...
path = "/Users/sophie/Desktop/Code/Ielts/listening/lesson/2/index.html"
